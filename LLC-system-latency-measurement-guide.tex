...
\begin{center}
	\begin{tabular}{||c c c||} 
		...
		\hline
		zcopy (20kHz) & 4.28 + 1.886 = \textbf{6.166} & \textbf{6 $\pm$ 1}\\
		\hline
		zcopy (50kHz) & 4.28 + 1.886 = \textbf{6.166} & \textbf{7 $\pm$ 1}\\
		\hline
		cpucopy (20kHz) & 4.1 + 4.36 = \textbf{8.46} & \textbf{9 $\pm$ 1}\\
		\hline
		cpucopy (50kHz) & 4.1 + 4.36 = \textbf{8.46} & \textbf{9 $\pm$ 1}\\ [1ex]
		\hline
	\end{tabular}
\end{center}
